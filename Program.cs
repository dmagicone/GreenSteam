...
public MainForm()
{
	...
	using (Stream stream = assembly.GetManifestResourceStream("SteamConfigEditor.background.png"))
	{
		if (stream != null)
    ...
    using (Stream stream = assembly.GetManifestResourceStream("SteamConfigEditor.icon.ico"))
    {
        if (stream != null)
